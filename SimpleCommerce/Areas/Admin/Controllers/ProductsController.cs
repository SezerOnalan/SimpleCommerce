...
namespace SimpleCommerce.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Photo,Price,Stock,IsFeatured,IsPublished,CategoryId")] Product product,IFormFile File)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Photo,Price,Stock,IsFeatured,IsPublished,CategoryId")] Product product,IFormFile File)
        {
            if (id != product.Id)
            {
                return NotFound();
