...
namespace SimpleCommerce.Controllers
{
    public class ShopController : ControllerBase
    {
        ...
        public IActionResult Checkout(string errorCode = "")
        {
            ...
            ViewBag.BillingCountries = new SelectList(_context.Regions.Where(r => r.RegionTeype == RegionType.Country).OrderBy(o => o.Name).ToList(), "Code", "Name");
            ViewBag.ShippingCountries = new SelectList(_context.Regions.Where(r => r.RegionTeype == RegionType.Country).OrderBy(o => o.Name).ToList(), "Code", "Name");
            return View(order);
        }
        ...
        public IActionResult Checkout(Order order)
        {
            ...
            ViewBag.BillingCountries = new SelectList(_context.Regions.Where(r => r.RegionTeype == RegionType.Country).OrderBy(o => o.Name).ToList(), "Code", "Name", order.Customer.BillingCountry);
            ViewBag.ShippingCountries = new SelectList(_context.Regions.Where(r => r.RegionTeype == RegionType.Country).OrderBy(o => o.Name).ToList(), "Code", "Name", order.Customer.ShippingCountry);
            return View(order);
        }
        private IActionResult IyzicoPayment(Order order)
        {
            ...
            var billingCounty = _context.Regions.FirstOrDefault(r => r.Code == order.Customer.BillingCounty && r.RegionTeype == RegionType.County)?.Name;
            var billingCity = _context.Regions.FirstOrDefault(r => r.Code == order.Customer.BillingCity && r.RegionTeype == RegionType.City)?.Name;
            var billingCountry = _context.Regions.FirstOrDefault(r => r.Code == order.Customer.BillingCountry && r.RegionTeype == RegionType.Country)?.Name;
            ...
            shippingAddress.City = _context.Regions.FirstOrDefault(r => r.Code == order.Customer.ShippingCity && r.RegionTeype == RegionType.City)?.Name;

            shippingAddress.Country = _context.Regions.FirstOrDefault(r => r.Code == order.Customer.ShippingCountry && r.RegionTeype == RegionType.Country)?.Name;
        ...
        public IList<Region> GetCities(string countryCode)
        {
            ...
            var cities = _context.Regions.Where(r => r.ParentRegionId == id && r.RegionTeype == RegionType.City).OrderBy(o => o.Name).ToList();
            return cities;
        }
        ...
        public IList<Region> GetCounties(string cityCode)
        {
            ...
            var counties = _context.Regions.Where(r => r.ParentRegionId == id && r.RegionTeype == RegionType.County).OrderBy(o => o.Name).ToList();
            return counties;
        }
    }
}